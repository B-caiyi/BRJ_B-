...
#import "SelectBtnViewController.h"
...
@interface SelectBtnViewController ()<UIScrollViewDelegate> {
...
@implementation SelectBtnViewController
...
{
    //滑框frame
    UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(0, 260, SCREEN_WIDTH, titleHeight)];
    ...
    for (int i = 0; i < _titleArray.count; i++) {
        ...
        [titleButton setTitleColor:[UIColor colorWithHexString:@"#A1A8B6"] forState:UIControlStateNormal];
    ...
    //滑块
    UIView *sliderV=[[UIView alloc]initWithFrame:CGRectMake(titleWidth/4+8, titleHeight-6, titleWidth/3, 3)];
    sliderV.layer.cornerRadius = 1.5;
    sliderV.layer.masksToBounds = YES;
    sliderV.backgroundColor = [UIColor colorWithHexString:@"#159695"];
...
- (void)selectButton:(NSInteger)index
{
    ...
    [selectButton setTitleColor:[UIColor colorWithHexString:@"#159695"] forState:UIControlStateNormal];
    [UIView animateWithDuration:0.3 animations:^{
        _sliderView.frame = CGRectMake(titleWidth*index+46, titleHeight-6, titleWidth/3, 3);
    }];
}
...
{
    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0,300, SCREEN_WIDTH, SCREEN_HEIGHT-64-44)];
