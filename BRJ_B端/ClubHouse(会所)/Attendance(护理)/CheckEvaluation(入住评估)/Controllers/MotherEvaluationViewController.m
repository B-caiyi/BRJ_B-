//
//  MotherEvaluationViewController.m
//  BRJ_B端
//
...
@interface MotherEvaluationViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
@implementation MotherEvaluationViewController
...
- (void)creatTableView
{
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 60, kWidth, kHeight-118) style:UITableViewStyleGrouped];
